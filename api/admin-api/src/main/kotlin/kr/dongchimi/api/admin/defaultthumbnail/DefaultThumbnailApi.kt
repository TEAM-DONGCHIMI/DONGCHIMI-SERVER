...
interface DefaultThumbnailApi {
    ...
    @ApiErrorCode(CommonErrorCode::class, "INVALID_INPUT")
    @ApiErrorCode(DefaultProductThumbnailErrorCode::class, "THUMBNAIL_NAME_EXISTS")
    fun create(
        @Parameter(hidden = true) apiUser: AdminApiUser,
    ...
    @ApiErrorCode(CommonErrorCode::class, "INVALID_INPUT")
    @ApiErrorCode(DefaultProductThumbnailErrorCode::class, "THUMBNAIL_NOT_FOUND", "THUMBNAIL_NAME_EXISTS")
    fun update(
        @Parameter(hidden = true) apiUser: AdminApiUser,
