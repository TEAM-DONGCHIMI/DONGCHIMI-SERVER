...
interface OwnerProductApi {
    ...
    @ApiErrorCode(CommonErrorCode::class, "INVALID_INPUT")
    @ApiErrorCode(MarketErrorCode::class, "MARKET_NOT_FOUND", "MARKET_ACCESS_DENIED")
    @ApiErrorCode(PreparedProductErrorCode::class, "PREPARED_PRODUCT_NOT_FOUND")
    fun saveDrafts(
        @Parameter(hidden = true) apiUser: OwnerApiUser,
        @Parameter(description = "마트 ID") @PathVariable marketId: Long,
    ...
    @ApiErrorCode(MarketErrorCode::class, "MARKET_NOT_FOUND", "MARKET_ACCESS_DENIED")
    @ApiErrorCode(PreparedProductErrorCode::class, "DRAFT_NOT_COMPLETED")
    fun confirmDrafts(
        @Parameter(hidden = true) apiUser: OwnerApiUser,
        @Parameter(description = "마트 ID") @PathVariable marketId: Long,
    ): ApiResponse<Unit>
    ...
    @ApiErrorCode(CommonErrorCode::class, "INVALID_INPUT")
    @ApiErrorCode(MarketErrorCode::class, "MARKET_NOT_FOUND", "MARKET_ACCESS_DENIED")
    @ApiErrorCode(ProductErrorCode::class, "INVALID_DISCOUNT_PERIOD")
    ...
    @ApiErrorCode(CommonErrorCode::class, "INVALID_INPUT")
    @ApiErrorCode(MarketErrorCode::class, "MARKET_NOT_FOUND", "MARKET_ACCESS_DENIED")
    @ApiErrorCode(ProductErrorCode::class, "PRODUCT_NOT_FOUND", "TYPE_MISMATCH", "INVALID_DISCOUNT_PERIOD")
    fun updateProduct(
        @Parameter(hidden = true) apiUser: OwnerApiUser,
        @Parameter(description = "마트 ID") @PathVariable marketId: Long,
        @Parameter(description = "상품 ID") @PathVariable productId: Long,
